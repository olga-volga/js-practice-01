  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        var fin = new Promise(function (resolve) {
          setTimeout(function () {
          ...
          windows.forEach(function (item) {
            Object(_closeModal__WEBPACK_IMPORTED_MODULE_6__["default"])(item);
          });
        });
      });
    });
...
/* harmony import */ var _openModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./openModal */ "./src/js/modules/openModal.js");
...
function modal() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        Object(_openModal__WEBPACK_IMPORTED_MODULE_2__["default"])(modal);
      });
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      Object(_openModal__WEBPACK_IMPORTED_MODULE_2__["default"])(document.querySelector(selector));
    }, time);
  }
...
function openImage() {
  var parentImg = document.querySelector('.works'),
  ...
  parentImg.addEventListener('click', function (e) {
    e.preventDefault();
...
function openModal(elem) {
  ...
  document.body.style.marginRight = "".concat(Object(_calcScroll__WEBPACK_IMPORTED_MODULE_0__["default"])(), "px");
}
...
function timer(selector, endtime) {
  ...
  function setTimer(selector, endtime) {
    ...
    function updateTimer() {
      var time = countTimeRemain(endtime);
